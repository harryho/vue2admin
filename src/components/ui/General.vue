          ...
          <div class="box box-default">
            ...
            <div class="box-body">
              <div class="callout callout-danger">
                ...
                <p>There is a problem that we need to fix. A wonderful serenity has taken possession of my entire soul, like
                  these sweet mornings of spring which I enjoy with my whole heart.</p>
              </div>
        ...
        <div class="col-md-6">
          <div class="box box-solid">
            ...
            <div class="box-body">
              ...
              <div class="progress">
                <div class="progress-bar progress-bar-yellow" role="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100"
                  style="width: 60%">
                  <span class="sr-only">60% Complete (warning)</span>
                </div>
              </div>
